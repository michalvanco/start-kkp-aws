...
export KUBECONFIG=`pwd`/focused-kare-kubeconfig
cd ..
```
...
kubectl create secret generic kubeconfig-cluster -n kubermatic --from-file=kubeconfig=`pwd`/kubeone/focused-kare-kubeconfig --dry-run=client -o yaml | kubectl apply -f -
